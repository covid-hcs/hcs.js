...
function writeLog(mod, con){
Fs.appendFile('check.log', '['+mod+'] '+JSON.stringify(con) + '\n', function(err) {
    ...
    async function(err, rows) {
        if (err) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                reg = rows[i].region;
                pw = rows[i].password.toString();
                lt = rows[i].loginType;
                await AutoCheck(code, hksengn, hsbirth, reg, pw,lt).catch;
                sleep(3000);
...
async function AutoCheck(code, Name, Birth, region, password,loginType) {
    ...
    var Serv = await Request(url+'/registerServey', {Authorization: Info.token}, {rspns00: "Y",rspns01: "1",rspns02: "1",rspns03: null,rspns04: null,rspns05: null,rspns06: null,rspns07: null,rspns08: "0",rspns09: "0",rspns10: null,rspns11: null,rspns12: null,rspns13: null,rspns14: null,rspns15: null,upperToken: Info.token,upperUserNameEncpt: Info.userName,deviceUuid: Info.deviceUuid});
    console.log(Serv);
}
